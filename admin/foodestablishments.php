        ...
        <div class="wrapper">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="#"><i class="fa-solid fa-utensils"></i>Food Establishments</a></li>
                    <li><a href="reviews.php"><i class="fa-solid fa-flag"></i>Reviews & Reports</a></li>
            ...
            <div class="container">
                <h2>Food Establishments of KainSaan</h2>
                <table class="table table-border table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $sel = "SELECT id, store_name, category, cuisine_type, parking_info, average_cost FROM food_establishments ORDER BY id ASC";
                            $query = $con->query($sel);
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['parking_info'];?></td>
                            <td><?php echo $row['average_cost'];?></td>
                        <td>
                            <a href="editFE.php?edit=<?php echo $row['id'];?>" class="btn btn-success" style="width:75px;">Edit</a>
                            <a href="deleteFE.php?delete=<?php echo $row['id'];?>" class="btn btn-danger">Delete</a>
                        </td>
                        </tr>
                        <?php
                            }
